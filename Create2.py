...
ll=str([hari,tanggal])
kk=str([xy,co])
hx=(f"""  [bold green1]DEVELOPER[medium_purple1]   ⟩ [bold green1] Admin
  [bold green1]FACEBOOK[medium_purple1]    ⟩ [bold green1]admin
...
def progres(current,num_accounts,delay):
		for sleep in range(int(delay), 0, -1):
			print(f'[bold magenta1]CREATING [bold white][[bold cyan]{current}[bold white]/[bold red]{num_accounts}[bold white]] SUCCESS-:[bold green1]{Ok}\r',end='\r')
			time.sleep(1)
