...
""")
ll=str([hari,tanggal])
hx=("""  [bold green1]DEVELOPER[medium_purple1]   ⟩[cyan][bold] Xian
  [bold green1]FACEBOOK[medium_purple1]    ⟩[cyan][bold] Xian 
  [bold green1]GITHUB[medium_purple1]      ⟩[bright_yellow] Xian.git
