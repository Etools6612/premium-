...
""")
ll=str([hari,tanggal])
hx=("""  [bold green1]DEVELOPER[medium_purple1]   ⟩[cyan][bold] Kristel
  [bold green1]FACEBOOK[medium_purple1]    ⟩[cyan][bold] admin 
  [bold green1]GITHUB[medium_purple1]      ⟩[bright_yellow] AUTOMATIC FB CREATION
  [bold green1]STATUS[medium_purple1]      ⟩[bright_yellow] ALL NETWORK 
  [bold green1]TOOLS[medium_purple1]       ⟩[green1] PREMIUM 
  [bold green1]UPDATES[medium_purple1]     ⟩[bright_yellow] January 
