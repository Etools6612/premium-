...
# ====== CORRECT CREDENTIALS ======
CORRECT_USERNAME = "trinityseven"
CORRECT_PASSWORD = "GabNisa79"
CORRECT_REDEEM = "Premium 0002"
...
def draw_menu(stdscr, selected_idx):
    ...
    logo = [
"______  _____  _____ _____ _______   ______________ _____ _____ _____  ",
"| ___ \|  _  ||  _  /  ___|_   _\ \ / /| ___ \ ___ \  ___/  ___/  ___| ",
"| |_/ /| | | || | | \ `--.  | |  \ V / | |_/ / |_/ / |__ \ `--.\ `--.  ",
"| ___ \| | | || | | |`--. \ | |  /   \ |  __/|    /|  __| `--. \`--. \ ",
"| |_/ /\ \_/ /\ \_/ /\__/ / | | / /^\ \| |   | |\ \| |___/\__/ /\__/ / ",
"\____/  \___/  \___/\____/  \_/ \/   \/\_|   \_| \_\____/\____/\____/  "
    ]
...
def run_action(stdscr, idx):
    ...
    if "ADD FACEBOOK ACCOUNT [ EXTRACTION ] " in chosen:
        ...
        input("Press Enter to return to menu...")
        return True
    elif "AUTOMATIC PAGE CREATION ( THRU COOKIES ) " in chosen:
        curses.endwin()
        bitz()
        input("Press Enter to return to menu...")
        return True
